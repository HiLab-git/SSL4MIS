...
parser.add_argument(
    "--exp",
    type=str,
    default="ACDC/Interpolation_Consistency_Training",
...
def train(args, snapshot_path):
    ...
    def create_model(ema=False):
        ...
        if (
            ema
        ):  # detach all tensors so that model for pseudo labels isnt updated with gradient
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            unlabeled_volume_batch = volume_batch[
                args.labeled_bs :
            ]  # first half is unlabeled
            labeled_volume_batch = volume_batch[
                : args.labeled_bs
            ]  # second half is labeled
            ...
            # Mix images
            batch_ux_mixed = (
                unlabeled_volume_batch_0 * (1.0 - ict_mix_factors)
            ...
            with torch.no_grad():
                ...
                batch_pred_mixed = (
                    ema_output_ux0 * (1.0 - ict_mix_factors)
            ...
            loss_ce = ce_loss(
                outputs[
                    : args.labeled_bs
                ],  # second half of data is the labeled portion (line 159)
