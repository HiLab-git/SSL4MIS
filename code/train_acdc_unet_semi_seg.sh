...
CUDA_VISIBLE_DEVICES=0 python train_uncertainty_rectifying_deep_supervision_2D.py --root_path ../data/ACDC --exp ACDC/Uncertainty_Rectifying_Deep_Supervised --num_classes 4 --labeled_num 7 && \
